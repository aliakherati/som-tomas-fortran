...
C-----VARIABLE DECLARATIONS------------------------------------------
      ...
      double precision alpha_i(5), kOH(15), OH_conc, Gc_i(15,15)
...
C      kw0 = 8.03E-05 
      ...
      write(*,*) 'Enter OH concentration [molecules cm-3]'
      read(*,*) OH_conc
      print*, 'OH_conc=', OH_conc
...
C------------------------------------------------------------
      ...
      time=0.0
      adt=10.*60. ! timestep for writing output [seconds]
...
C         print*, 'CSTAR=', CSTAR(j) , MWORG(j), pstar(j)
 ...
 904  FORMAT(A20,40F40.20)
      ...
      DO I=1,6
         CONST(I) = CONC0(I)
      END DO
      CONST(6) = OH_conc*1.0E6/6.022E23/PRES*R*TEMP*1.0E6 ! OH Concentration - molecules/cm3 -> ppm
...
C ----------------------------------------------------------------
     ...
     &        WalVapMas, tau_w, kw_HYBRID) !for normal case
